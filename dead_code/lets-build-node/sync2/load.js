...
const createRuleCollector = require('./load/ruleCollector');
/*
...
const loadSingleBuildFile = (filePath) => {
  ...
  */
  ...
  ```
   */
  const { collect, args } = createRuleCollector();
  ...
  */
  ...
  const load = (dirname) => (file) => {
    ...
    compiled.call(exports, exports, load(scriptDefinition.dirname), ...args)
    return exports
  };
...
if (typeof require != 'undefined' && require.main==module) {
  ...
  const buildFile = path.join(__dirname, '__test__', 'noop','BUILD.lets');
